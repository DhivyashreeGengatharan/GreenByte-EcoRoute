...
import CosmicParticleStream from './3d/CosmicParticleStream';
import DualCorridor3D from './3d/DualCorridor3D';
  ...
  return (
    <div className="landing-page-root">
      ...
      <section className="hero-section" style={{ position: 'relative', overflow: 'hidden' }}>
        <CosmicParticleStream count={700} />
      ...
      <section id="why-healthier" className="section-padding content-section">
        ...
        {/* 3D WebGL Comparative Dual Corridor Simulator */}
        <div className="animate-on-scroll" style={{ width: '100%', maxWidth: '1160px', margin: '28px auto 36px' }}>
          <DualCorridor3D />
        </div>
